const cartModalContent = (cartList) => {
        ...
        <div class="flex flex-col max-h-[calc(90vh-120px)]">
            ...
            <div class="p-4 border-b border-gray-200 bg-gray-50">
              <label class="flex items-center text-sm text-gray-700">
                <input type="checkbox" id="cart-modal-select-all-checkbox" class="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500 mr-2" ${cartList.every((item) => item.selected) ? "checked" : ""}>
            ...
            <div class="flex-1 overflow-y-auto">
              <div class="p-4 space-y-4">
                ...
                <div class="flex items-center py-3 border-b border-gray-100 cart-item" data-product-id="${item.productId}">
                  ...
                  focus:ring-blue-500" data-product-id="${item.productId}" ${item.selected ? "checked" : ""}>
                  </label>
                  <!-- 상품 이미지 -->
          ...
          <div class="sticky bottom-0 bg-white border-t border-gray-200 p-4">
            ...
            <div class="flex justify-between items-center mb-3 text-sm">
              <span class="text-gray-600">선택한 상품 (${cartList.filter((item) => item.selected).length}개)</span>
              <span class="font-medium">${cartList
            ...
            <div class="flex justify-between items-center mb-4">
              ...
              <span class="text-xl font-bold text-blue-600">${cartList.reduce((total, item) => total + item.lprice * item.quantity, 0).toLocaleString()}원</span>
            </div>
            <!-- 액션 버튼들 -->
            <div class="space-y-2">
